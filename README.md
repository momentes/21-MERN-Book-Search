![Tech tree](./tech-tree.png)

# Course Content Repository

This repository contains course content for the November 2022 Full-stack Flex course at Monash University.

New content will be published before class.

### Getting started (first time only)

To download the content for the first time, first `cd` into the directory in which you want the content:
...
```
git clone https://monash.bootcampcontent.com/monash-coding-bootcamp/MONU-VIRT-FSF-PT-11-2022-U-LOLC.git
```

### Updating content

To fetch the latest content, `cd` into your local directory containing the content and do a `git pull`:

```
cd my-study-folder/MONU-VIRT-FSF-PT-11-2022-U-LOLC
...
**MONU-VIRT-FSF-PT-11-2022-U-LOLC**
